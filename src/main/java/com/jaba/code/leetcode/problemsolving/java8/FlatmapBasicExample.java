  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        MessageFormat.format(
            "Non-Empty Optional Upper case: {0}", nonEmpty.map(String::toUpperCase)));
    System.out.println(
        MessageFormat.format("Empty Optional Upper case: {0}", empty.map(String::toUpperCase)));
    ...
    System.out.println(
        MessageFormat.format(
            "Optional.map: {0}", optionalOfOptionalNonEmpty.map(x -> x.map(String::toUpperCase))));
    System.out.println(
        MessageFormat.format(
            "Optional.map: {0}",
            optionalOfOptionalNonEmpty.flatMap(x -> x.map(String::toUpperCase))));
  }
}
