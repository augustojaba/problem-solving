...
public class ReverseInteger {
	...
	private static final List<Character> valueOfCards = java.util.Arrays.asList('2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A');
	...
	public static void main(String[] args) {
		...
		//System.out.println(solution(new String[] {"test1a", "test2", "test1b", "test1c", "test3"}, new String[] {"asa", "ok", "test1b", "ok", "test13"}));
		System.out.println(solution(new String[] {"codility1", "codility3", "codility2", "codility4b", "codility4a"}, new String[] {"asa", "ok", "ok", "odssds", "ok"}));
	}
